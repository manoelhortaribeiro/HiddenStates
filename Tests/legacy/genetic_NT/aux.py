...
def armgesture():
    n_labels = 6
    path = "/home/bruno.teixeira/ga3/hidden_states/Dataset/Data/NATOPS/GA_Discrete"
    folds = {}
    folds["Validation"] = (
    ...
    out = "/home/bruno.teixeira/ga3/hidden_states/Dataset/Output/Results/"
    return n_labels, folds, date, out


def armgesture2():
    n_labels = 6
    path = "/home/manoel/Projects/hidden_states_entropy/Dataset/Data/NATOPS/GA_Discrete"
    folds = {}
    folds["Validation"] = (
        path + "/Validation/dataValidationTest.csv", path + "/Validation/seqLabelsValidationTest.csv",
        path + "/Validation/dataValidationTrain.csv", path + "/Validation/seqLabelsValidationTrain.csv")
