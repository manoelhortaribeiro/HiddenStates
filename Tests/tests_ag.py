...
continuous_experiment_one = map(lambda a: '../Dataset/ArmGesture/'+a+'c.mat', datasets_experiment_one)
discrete_experiment_one = map(lambda a: '../Dataset/ArmGesture/'+a+'d.mat', datasets_experiment_one)

continuous_experiment_two = map(lambda a: '../Dataset/ArmGesture/'+a+'c.mat', datasets_experiment_two)
