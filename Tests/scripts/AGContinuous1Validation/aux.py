...
def armgesturethreefold():
    n_labels = 6
    folds = [1, 2, 3]
    path = "/home/bruno.teixeira/val_continuous/hidden_states/Dataset/Data/ArmGesture/Continuous1/"
    data = "data"
    label = "seqLabels"
    train = "Train"
    test = "Test"
    ...
    datapath = "/home/bruno.teixeira/val_continuous/hidden_states/Dataset/Data/ArmGesture/Continuous3/" + "ArmGestureDiscrete3.mat"
