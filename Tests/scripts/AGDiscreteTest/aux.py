...
def armgesture():
    ...
    folds = (path + "1/dataArmGestureDiscrete1.csv", path + "1/seqLabelsArmGestureDiscrete1.csv",
                     path + "2/dataArmGestureDiscrete2.csv", path + "2/seqLabelsArmGestureDiscrete2.csv")

    date = datetime.datetime.utcnow().strftime("%d_%m_%y-%H:%M")
    out = "/home/manoel/Projects/hidden_states_entropy/Dataset/Output/Results/"
    datapath = "/home/manoel/Projects/hidden_states_entropy/Dataset/Data/ArmGesture/Discrete3/" + "ArmGestureDiscrete3.mat"

    return n_labels, folds, date, out, datapath

def armgesture():
    n_labels = 6
    path = "/home/bruno.teixeira/agtest/hidden_states/Dataset/Data/ArmGesture/Discrete"
    ...
    datapath = "/home/bruno.teixeira/agtest/hidden_states/Dataset/Data/ArmGesture/Discrete3/" + "ArmGestureDiscrete3.mat"
