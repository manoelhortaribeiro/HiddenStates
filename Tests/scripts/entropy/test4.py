...
n_jobs = 8
seed = 1
description = "cad120_5i1s_t30"
detailed = "Full random init, seed 1, jobs 8, svmiter 5"
...
svmiter = 7
description = "cad120_7i1s_t30"
detailed = "Full random init, seed 1, jobs 8, svmiter 7"
